  ...
  return (
    <Card className='mt-4 w-[300px] rounded-lg border border-gray-200 bg-white py-4 shadow-lg'>
      <CardContent className='p-4'>
        ...
        <div className='mb-4'>
          <h3 className='mb-2 text-md font-semibold text-gray-700'>Categorías:</h3>
          {[1, 2, 3, 45].map((categoryId) => (
        ...
        <div className='mb-4'>
          <h3 className='mb-2 text-md font-semibold text-gray-700'>Rango de precios:</h3>
